...
class IiifController < ApplicationController
  ...
  def degraded?
    !can?(:access, current_image) && current_image.accessable_by?(User.stanford_generic_user) ||
      !can?(:download, current_image) && current_image.readable_by?(User.stanford_generic_user)
  end
end
