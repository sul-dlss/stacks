...
RSpec.describe "It proxies image requests to a remote IIIF server (canteloupe)" do
  let(:info_request) do
    "https://sul-imageserver-prod.stanford.edu/iiif/2/nr%2F349%2Fct%2F7889%2Fimage.jp2/info.json"
  end
  ...
  let(:image_response) do
    "https://sul-imageserver-prod.stanford.edu/iiif/2/nr%2F349%2Fct%2F7889%2Fimage.jp2/full/max/0/default.jpg"
  end
