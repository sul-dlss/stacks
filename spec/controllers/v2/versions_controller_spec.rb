...
RSpec.describe V2::VersionsController do
  before do
  ...
  describe '#show' do
    subject { get :show, params: { id: druid, file_name: 'image.jp2', version_id: } }
    ...
    it 'sends headers for content' do
      ...
      get :show, params: { id: druid, file_name: 'image.jp2', download: 'any', version_id: }
