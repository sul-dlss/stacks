...
describe LegacyImageServiceController, :vcr do
  describe 'Precast sizes' do
    ...
    context 'thumbs' do
      it 'works' do
        page = get :show, id: 'nr349ct7889', file_name: 'nr349ct7889_00_0001', size: 'thumb'
    ...
    context 'small' do
      it 'works' do
        page = get :show, id: 'nr349ct7889', file_name: 'nr349ct7889_00_0001', size: 'small'
    ...
    context 'medium' do
      it 'works' do
        page = get :show, id: 'nr349ct7889', file_name: 'nr349ct7889_00_0001', size: 'medium'
    ...
    context 'large' do
      it 'works' do
        page = get :show, id: 'nr349ct7889', file_name: 'nr349ct7889_00_0001', size: 'large'
    ...
    context 'xlarge' do
      it 'works' do
        page = get :show, id: 'nr349ct7889', file_name: 'nr349ct7889_00_0001', size: 'xlarge'
    ...
    context 'full' do
      it 'works' do
        page = get :show, id: 'nr349ct7889', file_name: 'nr349ct7889_00_0001', size: 'full'
